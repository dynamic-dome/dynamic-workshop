...
**Wellen A + B + C + D sind erledigt und committet. NÄCHSTER EINSTIEG: Welle E (Übungen & Demos).**
...
→ **Weiter mit Welle E — Übungen & Demos** (siehe Abschnitt 4): neue Übungen aus `resources/review-2026-06-21/05-new-exercises.md` + `05b-…welle-2.md` einpflegen; Demo-Robustheit `T-014` (garantiert-lokaler Live-Anker Session 3), `T-015` (Plugin-Fallbacks in Exercise 3.3), `T-016` (broken-greeter/SKILL.md als Asset), `T-027` (Go/No-Go-Demo-Matrix). Optional die P2/P3-Reste anderer Cluster (z.B. `exercise-quality` T-030/018/053/069/070/081/054/082, `accuracy-overclaim` OSDP-Fixes T-008/062/037/070, `demo-reliability`). **Welle F (Restrukturierung / 48 Lerneinheiten) bleibt gated** auf die User-Entscheidung „3 vs. 4 Sessions".
